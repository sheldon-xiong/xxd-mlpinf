...
def main():
    ...
    # python3 -m code.gptj.tensorrt.infer --engine_file /path/to/engine/DGX-H100_H100-SXM-80GBx1/gptj/Offline/gptj-Offline-gpu-b32-fp16.custom_k_99_9_MaxP.plan --num_samples=8 --batch_size=8  --num_beams=4 --skip_engine_build
    # Torch
