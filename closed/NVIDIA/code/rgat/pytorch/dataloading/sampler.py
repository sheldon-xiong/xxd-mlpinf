...
# https://github.com/mlcommons/training_results_v4.1/blob/main/NVIDIA/benchmarks/gnn/implementations/h200_ngc24.04_dgl/dataloading/sampler.py
...
class PyGSampler(dgl.dataloading.Sampler):
    ...
    def sample(self, g, seed_nodes):
        ...
        if not g.label.is_cuda:
            target_labels = g.label[seed_nodes['paper'].cpu()]
        else:
